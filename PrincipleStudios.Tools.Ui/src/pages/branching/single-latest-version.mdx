...
<img
	src={releaseCandidateFromFeatures.src}
	alt="Git diagram showing a release candidate being merged to main and cleaning up other branches"
/>
...
<img
	src={reintegrateIntegration.src}
	alt="Git diagram showing an integration branch being used to resolve merge conflicts by merging prior to the service line"
/>
