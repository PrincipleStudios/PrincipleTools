...
# FAQ's for the Scalable Git Branching Strategy

## What are the scalable git branching strategy gotchas?
...
requirements. Components in the Scalable Git Branching Strategy are intended to
